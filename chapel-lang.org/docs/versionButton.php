...
function dropSetup() {
  var currentRelease = "2.10"; // what does the public have?
  var stagedRelease = "2.11";  // is there a release staged but not yet public?
  var nextRelease = "2.11";    // what's the next release? (on docs/main)
