...
function dropSetup() {
  var currentRelease = "2.4"; // what does the public have?
  var stagedRelease = "2.5";  // is there a release staged but not yet public?
  var nextRelease = "2.5";    // what's the next release? (on docs/main)
