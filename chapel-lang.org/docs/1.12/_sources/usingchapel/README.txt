...
and industry. See `chapel-lang.org`_ for more information.

.. _Cray Inc.: http://www.cray.com/
.. _chapel-lang.org: https://chapel-lang.org/
...
.. _prereqs.rst: https://chapel-lang.org/docs/1.12/usingchapel/prereqs.html
...
.. _chplenv.rst: https://chapel-lang.org/docs/1.12/usingchapel/chplenv.html
...
.. _multilocale.rst: https://chapel-lang.org/docs/1.12/usingchapel/multilocale.html
...
----------------------------------------------- -------------------------------------
    ...
    other Chapel Documentation                  `chapel-lang.org/docs`_
    third-party software that we use            ``third-party/README``
=============================================== =====================================


.. _chapel-lang.org/docs: https://chapel-lang.org/docs/1.12/
.. _building.rst: https://chapel-lang.org/docs/1.12/usingchapel/building.html
.. _compiling.rst: https://chapel-lang.org/docs/1.12/usingchapel/compiling.html
.. _executing.rst: https://chapel-lang.org/docs/1.12/usingchapel/executing.html
.. _debugging.rst: https://chapel-lang.org/docs/1.12/usingchapel/debugging.html
.. _bugs.rst: https://chapel-lang.org/docs/1.12/usingchapel/bugs.html
...
.. _cray.rst: https://chapel-lang.org/docs/1.12/platforms/cray.html
.. _cygwin.rst: https://chapel-lang.org/docs/1.12/platforms/cygwin.html
